...
export const READ_VATICANO: DailyRead = {
  ...
  stageUnlock: 1,
  difficulty: 7,
  titleL1: "Una mattina ai Musei Vaticani",
  ...
  paragraphs: [
    {
      l1: "La sveglia suona alle sei. È una mattina importante: oggi visito i Musei Vaticani e la Cappella Sistina. Ho prenotato il biglietto online due settimane fa, per evitare la fila lunghissima all'ingresso.",
    ...
    {
      l1: "Bevo un caffè veloce all'hotel e prendo la metro. La fermata «Ottaviano» è quella giusta per il Vaticano. Quando esco dalla stazione, vedo le mura alte e bianche dei giardini vaticani sulla sinistra. Cammino per dieci minuti.",
    ...
    {
      l1: "All'ingresso mostro il biglietto sul telefono. Una guardia in uniforme grigia controlla, sorride, e mi fa passare. Dentro c'è già molta gente, ma niente come la fila esterna che ho visto passando: lì le persone aspettano almeno due ore sotto il sole.",
    ...
    {
      l1: "I musei sono un labirinto. Ci sono statue antiche, mosaici, mappe enormi di carta sulle pareti, e corridoi che sembrano infiniti. Una guida americana spiega a un gruppo di turisti che i Musei Vaticani contengono più di settantamila opere d'arte. È difficile credere a un numero così grande.",
    ...
    {
      l1: "Cammino piano. Mi piace fermarmi davanti alle sculture e leggere le piccole targhe in italiano. A volte capisco tutto, a volte capisco solo metà. Una signora accanto a me ha detto a suo marito: «Guarda quella statua, è perfetta — sembra viva.» E aveva ragione.",
    ...
    {
      l1: "Quando esco dal museo, sono stanco ma pieno di immagini. Compro una bottiglia d'acqua fredda da un venditore vicino alla piazza. Penso che alcuni luoghi rimangono dentro di te per sempre — e la Cappella Sistina è uno di quelli.",
  ...
  vocabSpotlight: [
    { l1: "prenotare", en: "to book / reserve" },
    { l1: "evitare", en: "to avoid" },
    { l1: "la fila", en: "the line / queue" },
    { l1: "la mura / le mura", en: "the wall / walls (of a city)" },
    { l1: "la guardia", en: "the guard" },
    { l1: "il labirinto", en: "the labyrinth / maze" },
    { l1: "l'opera d'arte", en: "the work of art" },
    { l1: "la targa", en: "the plaque / label" },
    { l1: "il soffitto", en: "the ceiling" },
    { l1: "la panchina", en: "the bench" },
  ],
  comprehension: [
    {
