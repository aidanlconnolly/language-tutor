...
export const READ_BAR_MORNING: DailyRead = {
  ...
  paragraphs: [
    {
      l1: "Sono le sette del mattino. Esco dall'hotel. Cammino verso il bar all'angolo. Si chiama «Bar Sant'Andrea».",
      en: "It's seven in the morning. I leave the hotel. I walk to the bar on the corner. It's called \"Bar Sant'Andrea.\"",
    },
    {
      l1: "Entro nel bar. C'è un buon odore di caffè e di pane. Due uomini sono al bancone. Bevono il caffè in piedi.",
      en: "I enter the bar. There's a nice smell of coffee and bread. Two men are at the counter. They drink coffee standing up.",
    },
    {
      l1: "Una ragazza giovane è dietro il bancone. Lei mi sorride. «Buongiorno! Cosa desidera?»",
      en: "A young woman is behind the counter. She smiles at me. \"Good morning! What would you like?\"",
    },
    {
      l1: "«Buongiorno. Vorrei un cappuccino e un cornetto, per favore.» «Il cornetto alla crema o alla marmellata?» «Alla crema, grazie.»",
      en: "\"Good morning. I'd like a cappuccino and a cornetto, please.\" \"Cornetto with cream or with jam?\" \"With cream, thank you.\"",
    },
    {
      l1: "Lei usa la macchina del caffè. Dopo un minuto mi porta il cappuccino. Sulla schiuma c'è un cuore bianco. È molto bello.",
    ...
    {
      l1: "Bevo un sorso. Il caffè è perfetto: caldo, forte, ma non amaro. Il cornetto è dolce e leggero. Mi piace molto.",
      en: "I take a sip. The coffee is perfect: hot, strong, but not bitter. The cornetto is sweet and light. I like it very much.",
    },
    {
      l1: "Un uomo al bancone mi guarda. «Lei è straniero?» mi chiede. «Sì, sono americano.» Lui sorride. «Benvenuto a Roma! Le piace il cappuccino?»",
    ...
    {
      l1: "«Sì, è buonissimo!» Lui ride. «Bene. Ma ricorda: in Italia il cappuccino è solo per la mattina. Mai dopo le dieci!» Pago il conto. Costa tre euro. Esco dal bar. La giornata comincia bene.",
  ...
  vocabSpotlight: [
    { l1: "il bar", en: "the bar (more like a café)" },
    { l1: "il bancone", en: "the counter" },
    { l1: "il cappuccino", en: "the cappuccino (morning only!)" },
    { l1: "il cornetto", en: "the cornetto (Italian croissant)" },
    { l1: "la marmellata", en: "the jam" },
    { l1: "la crema", en: "pastry cream" },
    { l1: "amaro", en: "bitter" },
