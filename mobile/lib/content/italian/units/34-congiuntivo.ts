  ...
  lessons: [
    {
      ...
      pages: [
        ...
        },
        {
          ...
          items: [
            { l1: "penso che…", en: "I think that…" },
            { l1: "credo che…", en: "I believe that…" },
            { l1: "spero che…", en: "I hope that…" },
            { l1: "voglio che…", en: "I want that…" },
            { l1: "preferisco che…", en: "I prefer that…" },
            { l1: "ho paura che…", en: "I'm afraid that…" },
            { l1: "mi sembra che…", en: "it seems to me that…" },
            { l1: "è importante che…", en: "it's important that…" },
            { l1: "bisogna che…", en: "it's necessary that…" },
            { l1: "è meglio che…", en: "it's better that…" },
            { l1: "non sono sicuro che…", en: "I'm not sure that…" },
            { l1: "benché / sebbene / nonostante", en: "although / despite" },
            { l1: "prima che / a meno che / purché", en: "before / unless / provided that" },
          ],
        },
        {
          type: "tip",
    ...
    },
    {
      ...
      pages: [
        ...
        },
        {
          ...
          items: [
            { l1: "spero che + subj.", en: "I hope that…" },
            { l1: "è importante / necessario che + subj.", en: "it's important / necessary that…" },
            { l1: "bisogna che + subj.", en: "it's necessary that…" },
            { l1: "voglio che + subj.", en: "I want that…" },
            { l1: "preferisco che + subj.", en: "I prefer that…" },
            { l1: "benché / sebbene / nonostante + subj.", en: "although / despite the fact that…" },
            { l1: "prima che + subj.", en: "before…" },
            { l1: "a meno che (non) + subj.", en: "unless…" },
            { l1: "purché + subj.", en: "provided that…" },
            { l1: "chiunque / qualunque + subj.", en: "whoever / whatever…" },
          ],
        },
        {
          type: "dialogue",
          ...
          setup: "Two friends.",
          lines: [
            { speaker: "Anna", l1: "Pensi che Marco venga stasera?", en: "Do you think Marco's coming tonight?" },
            { speaker: "You", l1: "Spero di sì. Mi ha detto che voleva, ma non è sicuro.", en: "I hope so. He told me he wanted to, but it's not certain." },
            { speaker: "Anna", l1: "È strano che non ci abbia detto niente fino ad ora.", en: "It's strange he hasn't told us anything until now." },
            { speaker: "You", l1: "Magari sta lavorando ancora. È possibile che debba fare gli straordinari.", en: "Maybe he's still working. It's possible he has to do overtime." },
            { speaker: "Anna", l1: "Vabbè, lo aspettiamo. Voglio che assaggi questo vino — è incredibile.", en: "Whatever, we'll wait. I want him to taste this wine — it's incredible." },
          ],
        },
        {
          type: "fillBlank",
