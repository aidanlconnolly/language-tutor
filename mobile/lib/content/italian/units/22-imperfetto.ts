      ...
      pages: [
        ...
        },
        {
          ...
          items: [
            { l1: "spesso", en: "often" },
            { l1: "sempre", en: "always" },
            { l1: "di solito", en: "usually" },
            { l1: "ogni giorno / ogni estate", en: "every day / every summer" },
            { l1: "tutti i giorni", en: "every day" },
            { l1: "mentre", en: "while" },
            { l1: "da bambino/a", en: "as a child" },
            { l1: "una volta", en: "once / back then" },
            { l1: "a quei tempi", en: "in those days" },
            { l1: "negli anni '80", en: "in the '80s" },
          ],
        },
        {
          type: "tip",
        ...
        },
        {
          ...
          lines: [
            { speaker: "Anna", l1: "Dove abitavi da piccolo?", en: "Where did you used to live as a kid?" },
            { speaker: "You", l1: "Abitavamo in una piccola città in Vermont. C'era molto verde, e nevicava sempre d'inverno.", en: "We lived in a small town in Vermont. There was lots of green, and it always snowed in winter." },
            { speaker: "Anna", l1: "Andavi a scuola a piedi?", en: "Did you walk to school?" },
            { speaker: "You", l1: "No, prendevo lo scuolabus. Era giallo, come nei film americani. Mio fratello e io aspettavamo alla fermata ogni mattina, anche quando faceva freddissimo.", en: "No, I took the school bus. It was yellow, like in American movies. My brother and I waited at the stop every morning, even when it was really cold." },
            { speaker: "Anna", l1: "E cosa facevate il sabato?", en: "And what did you (all) used to do on Saturday?" },
            { speaker: "You", l1: "Andavamo in piscina o al parco. Erano giornate semplici. Mi piaceva molto.", en: "We used to go to the pool or the park. They were simple days. I liked it a lot." },
          ],
        },
        {
          type: "multipleChoice",
    ...
    },
    {
      ...
      pages: [
        ...
        },
        {
          ...
          lines: [
            { speaker: "Marco", l1: "Cosa è successo? Come ti sei fatto male?", en: "What happened? How did you hurt yourself?" },
            { speaker: "You", l1: "Allora, ieri pomeriggio camminavo a Trastevere. Faceva caldo, c'era molta gente per strada.", en: "So, yesterday afternoon I was walking in Trastevere. It was hot, there were lots of people on the street." },
            { speaker: "You", l1: "Guardavo le vetrine, non guardavo i miei piedi. Improvvisamente sono inciampato in un sampietrino sconnesso.", en: "I was looking at the shop windows, I wasn't looking at my feet. Suddenly I tripped on a loose cobblestone." },
            { speaker: "You", l1: "Sono caduto male. Ho sentito un dolore forte alla caviglia.", en: "I fell badly. I felt a sharp pain in my ankle." },
            { speaker: "Marco", l1: "Sei andato al pronto soccorso?", en: "Did you go to the ER?" },
            { speaker: "You", l1: "Sì. Mentre aspettavo, ho visto che si gonfiava. Per fortuna non era rotta — solo una bella distorsione.", en: "Yes. While I was waiting, I saw it was swelling. Luckily it wasn't broken — just a good sprain." },
          ],
        },
        {
          type: "fillBlank",
        ...
        },
        {
          ...
          items: [
            ...
            { tokens: ["Pioveva", ",", "ma", "siamo", "andati", "al", "parco", "lo", "stesso"], alts: [["Pioveva", ",", "ma", "siamo", "andati", "lo", "stesso", "al", "parco"]], en: "It was raining, but we went to the park anyway." },
