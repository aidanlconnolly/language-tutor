...
export const READ_APERITIVO: DailyRead = {
  ...
  stageUnlock: 1,
  difficulty: 7.5,
  titleL1: "Aperitivo vicino a Piazza Navona",
  ...
  paragraphs: [
    {
      l1: "Erano le sei della sera quando ho deciso di fare l'aperitivo. Mentre camminavo verso Piazza Navona, il cielo era arancione e l'aria era più fresca. Roma a quell'ora ha una luce speciale, una luce che chiamano in italiano «la dorata».",
    ...
    {
      l1: "Vicino alla piazza c'era un piccolo bar che mi aveva consigliato Lucia, la signora della trattoria di Trastevere. Si chiamava «Il Bicchiere d'Oro». Sono entrato e mi sono seduto a un tavolino esterno con una buona vista sulla strada.",
    ...
    {
      l1: "Il cameriere è arrivato subito. Era giovane, magro, con un sorriso aperto. «Buonasera. Cosa Le porto?» «Un Aperol Spritz, per favore.» «Subito! Per l'aperitivo, oggi abbiamo olive nere, formaggio, focaccia con il pomodoro. Va bene per Lei?»",
    ...
    {
      l1: "Ho detto di sì e dopo cinque minuti era tutto sul mio tavolo: un bicchiere alto con il liquido arancione, una piccola fetta di arancia all'interno, e tre piattini di stuzzichini. Tutto incluso nel prezzo, otto euro. Non male per quello che ti danno.",
    ...
    {
      l1: "Ho bevuto piano e ho guardato la gente. C'era una coppia anziana che parlava sottovoce. Due ragazze ridevano e si scambiavano il telefono per mostrare foto. Un padre cercava di convincere il suo bambino piccolo a finire un gelato che si scioglieva sulla mano.",
    ...
    {
      l1: "Mentre osservavo, il cameriere è tornato. «Tutto bene?» «Sì, molto. Mi può consigliare un posto per cena dopo?» Ha pensato un momento. «Dipende. Cosa preferisce — la pasta o la pizza? Romano o internazionale?» «Romano, sicuramente. Qualcosa di tipico.»",
    ...
    {
      l1: "Mi ha scritto su un piccolo foglio il nome di una trattoria a Testaccio, un quartiere meno turistico. «È un po' lontano, ma vale la pena. Prenda l'autobus 75 dalla fermata davanti.» Ho messo il foglio nel portafoglio, ho pagato, e ho ringraziato.",
    ...
    {
      l1: "Mentre uscivo, il cielo era ormai viola scuro. Le luci dei lampioni si erano accese. Pensavo: questo era il mio momento preferito della giornata romana — quello tra il giorno e la notte, quando la città cambia carattere ma resta sempre se stessa.",
  ...
  vocabSpotlight: [
    { l1: "l'aperitivo", en: "the aperitivo (pre-dinner drink + snacks)" },
    { l1: "consigliare", en: "to recommend" },
    { l1: "il cameriere", en: "the waiter" },
    { l1: "lo stuzzichino", en: "the snack / small bite" },
    { l1: "incluso", en: "included" },
    { l1: "sottovoce", en: "in a low voice / quietly" },
    { l1: "sciogliere / si scioglieva", en: "to melt / it was melting" },
    { l1: "valere la pena", en: "to be worth it" },
    { l1: "il lampione", en: "the streetlight" },
