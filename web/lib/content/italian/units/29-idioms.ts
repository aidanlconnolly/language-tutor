  ...
  lessons: [
    {
      ...
      pages: [
        ...
        },
        {
          ...
          items: [
            { l1: "in bocca al lupo!", en: "good luck! ('into the wolf's mouth') → reply: crepi! or crepi il lupo!" },
            { l1: "magari!", en: "I wish! / hopefully!" },
            { l1: "boh", en: "dunno / no idea (with a small shrug)" },
            { l1: "che palle!", en: "what a pain! (mildly vulgar)" },
            { l1: "non vedo l'ora", en: "I can't wait" },
            { l1: "alla grande", en: "great / awesome (response to 'come va?')" },
            { l1: "che figata!", en: "how cool!" },
            { l1: "che barba!", en: "how boring!" },
            { l1: "in gamba!", en: "smart / capable person; also a sendoff: 'take care'" },
            { l1: "tutto a posto", en: "all good / all set" },
            { l1: "che ne so", en: "what do I know / who knows" },
            { l1: "ma dai!", en: "come on! / no way! (surprise or disbelief)" },
            { l1: "figurati!", en: "don't mention it / no problem (response to thanks)" },
            { l1: "tanto", en: "anyway / whatever" },
            { l1: "fa schifo", en: "it sucks / it's gross" },
          ],
        },
        {
          type: "tip",
    ...
    },
    {
      ...
      pages: [
        ...
        },
        {
          ...
          items: [
            { l1: "essere al verde", en: "to be broke ('to be at the green' — from old card-table cloth)" },
            { l1: "non avere peli sulla lingua", en: "to not mince words ('no hair on the tongue')" },
            { l1: "tirare i remi in barca", en: "to give up / pull the oars in the boat" },
            { l1: "perdere la testa", en: "to lose your head (over someone or in love)" },
            { l1: "essere in gamba", en: "to be smart / capable" },
            { l1: "costa un occhio della testa", en: "costs an arm and a leg" },
            { l1: "fare il furbo", en: "to play smart (negative — to cheat)" },
            { l1: "non c'entra niente", en: "it has nothing to do with it" },
            { l1: "essere il fanalino di coda", en: "to be the last (in a race / class)" },
            { l1: "essere come cane e gatto", en: "to fight like dog and cat" },
            { l1: "lavorare come un mulo", en: "to work like a mule" },
            { l1: "fare la gattina morta", en: "to play innocent / sweet (lit. 'play dead kitten')" },
            { l1: "essere una volpe", en: "to be a fox (= cunning)" },
            { l1: "avere una fame da lupi", en: "to be hungry as wolves" },
          ],
        },
        {
          type: "dialogue",
          ...
          setup: "Catching up.",
          lines: [
            { speaker: "Marco", l1: "Anna, come stai? Sembri stanca.", en: "Anna, how are you? You look tired." },
            { speaker: "Anna", l1: "Lavoro come un mulo. Tre progetti contemporaneamente.", en: "I'm working like a mule. Three projects at the same time." },
            { speaker: "Marco", l1: "Che palle. Ma almeno ti pagano bene?", en: "What a pain. But at least they pay well?" },
            { speaker: "Anna", l1: "Boh. Per ora non vedo l'ora che finisca questa settimana.", en: "Dunno. For now I can't wait for this week to end." },
            { speaker: "Marco", l1: "Ti capisco. Magari sabato facciamo qualcosa per staccare?", en: "I get you. Maybe Saturday we'll do something to unplug?" },
            { speaker: "Anna", l1: "Magari! Sarebbe perfetto.", en: "I wish! That would be perfect." },
          ],
        },
        {
          type: "fillBlank",
    ...
    },
    {
      ...
      pages: [
        ...
        },
        {
          ...
          items: [
            { l1: "ma cosa dici?!", en: "but what are you saying?! (the 🤌 gesture in words)" },
            { l1: "che vuoi?!", en: "what do you want?! (also 🤌)" },
            { l1: "che ne so / chissà", en: "what do I know / who knows" },
            { l1: "non m'importa", en: "I don't care (chin flick)" },
            { l1: "delizioso! / buonissimo!", en: "delicious! (cheek brush)" },
            { l1: "stai attento!", en: "be careful! (eye pull-down)" },
            { l1: "porta sfortuna", en: "it brings bad luck (horns)" },
            { l1: "tocca ferro", en: "touch iron (= knock on wood; Italians touch iron, not wood)" },
            { l1: "mi fai impazzire", en: "you drive me crazy" },
            { l1: "che casino", en: "what a mess / chaos" },
          ],
        },
        {
          type: "tip",
