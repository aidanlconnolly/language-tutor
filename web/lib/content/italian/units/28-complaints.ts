  ...
  lessons: [
    {
      ...
      pages: [
        ...
        },
        {
          ...
          items: [
            { l1: "il problema", en: "the problem" },
            { l1: "non funziona", en: "it doesn't work" },
            { l1: "è rotto / rotta", en: "it's broken (m / f)" },
            { l1: "è guasto / guasta", en: "it's out of order" },
            { l1: "non va bene", en: "it's not okay" },
            { l1: "non sono soddisfatto / a", en: "I'm not satisfied (m / f)" },
            { l1: "mi aspettavo (di più)", en: "I expected (more)" },
            { l1: "vorrei segnalare", en: "I'd like to point out / report" },
            { l1: "il reclamo", en: "the formal complaint" },
            { l1: "il responsabile / il direttore", en: "the manager / director" },
            { l1: "il rimborso", en: "the refund" },
            { l1: "il cambio", en: "the exchange (item)" },
            { l1: "il reso", en: "the return" },
            { l1: "la garanzia", en: "the warranty" },
            { l1: "uno sconto", en: "a discount" },
          ],
        },
        {
          type: "tip",
    ...
    },
    {
      ...
      pages: [
        ...
        },
        {
          ...
          lines: [
            { speaker: "You", l1: "Mi scusi, c'è un piccolo errore. Avevo ordinato la cacio e pepe, non le tagliatelle.", en: "Excuse me, there's a small mistake. I had ordered the cacio e pepe, not the tagliatelle." },
            { speaker: "Cameriere", l1: "Oh, mi dispiace tantissimo! Devo aver scambiato i tavoli. Le porto subito la cacio e pepe.", en: "Oh, I'm so sorry! I must have mixed up the tables. I'll bring you the cacio e pepe right away." },
            { speaker: "You", l1: "Grazie. Quanto tempo ci vuole?", en: "Thanks. How long will it take?" },
            { speaker: "Cameriere", l1: "Cinque minuti, glielo dico al cuoco di farla per prima.", en: "Five minutes, I'll tell the chef to do it first." },
            { speaker: "You", l1: "Perfetto, nessun problema.", en: "Perfect, no problem." },
          ],
        },
        {
          type: "dialogue",
          ...
          lines: [
            { speaker: "You", l1: "Buonasera. Scusi se La disturbo, ma vorrei segnalare un problema con la camera.", en: "Good evening. Sorry to bother you, but I'd like to report a problem with the room." },
            { speaker: "Receptionist", l1: "Mi dica.", en: "Tell me." },
            { speaker: "You", l1: "La camera dà sulla strada e c'è troppo rumore. Sarebbe possibile cambiarmi camera?", en: "The room faces the street and there's too much noise. Would it be possible to change my room?" },
            { speaker: "Receptionist", l1: "Capisco. Un attimo che controllo… Sì, ho una camera al quarto piano, sul cortile interno. Molto più silenziosa.", en: "I understand. One moment, let me check… Yes, I have a room on the fourth floor, facing the inner courtyard. Much quieter." },
            { speaker: "You", l1: "Perfetto, La ringrazio.", en: "Perfect, thank you." },
            { speaker: "Receptionist", l1: "Le prepariamo le chiavi subito. Mi scusi per il disagio.", en: "We'll prepare the keys right away. I apologize for the inconvenience." },
          ],
        },
        {
          type: "fillBlank",
    ...
    },
    {
      ...
      pages: [
        ...
        },
        {
          ...
          items: [
            { l1: "il rimborso", en: "the refund (money back)" },
            { l1: "il cambio / lo scambio", en: "the exchange" },
            { l1: "il reso", en: "the return (act of returning)" },
            { l1: "la garanzia", en: "the warranty" },
            { l1: "il buono / il voucher", en: "store credit / voucher" },
            { l1: "difettoso / a", en: "defective" },
            { l1: "guasto / a", en: "broken / out of order" },
            { l1: "rotto / a", en: "broken" },
            { l1: "non funziona più", en: "it no longer works" },
            { l1: "mai usato / indossato", en: "never used / worn" },
            { l1: "ancora con l'etichetta", en: "still with the tag" },
            { l1: "entro X giorni", en: "within X days" },
        ...
        },
        {
          ...
          lines: [
            { speaker: "You", l1: "Buongiorno. Ho comprato queste cuffie tre giorni fa e non funzionano. Vorrei un rimborso.", en: "Hello. I bought these headphones three days ago and they don't work. I'd like a refund." },
            { speaker: "Commessa", l1: "Cosa esattamente non funziona?", en: "What exactly doesn't work?" },
            { speaker: "You", l1: "Non si collegano al telefono. Ho provato con due telefoni diversi.", en: "They don't pair with the phone. I tried with two different phones." },
            { speaker: "Commessa", l1: "Ha lo scontrino?", en: "Do you have the receipt?" },
            { speaker: "You", l1: "Sì, eccolo.", en: "Yes, here it is." },
            { speaker: "Commessa", l1: "Va bene. Posso offrirLe il cambio o il rimborso?", en: "Okay. Can I offer you an exchange or a refund?" },
            { speaker: "You", l1: "Preferisco il rimborso, grazie.", en: "I prefer the refund, thank you." },
            { speaker: "Commessa", l1: "Va bene. Il rimborso va sulla carta usata, entro tre giorni lavorativi.", en: "Okay. The refund goes on the card you used, within three business days." },
            { speaker: "You", l1: "Perfetto, grazie.", en: "Perfect, thank you." },
          ],
        },
        {
          type: "fillBlank",
