    ...
    },
    {
      ...
      pages: [
        ...
        },
        {
          ...
          items: [
            { l1: "essere → sarò", en: "I will be (the most-used one)" },
            { l1: "avere → avrò", en: "I will have" },
            { l1: "andare → andrò", en: "I will go" },
            { l1: "fare → farò", en: "I will do / make" },
            { l1: "dare → darò", en: "I will give" },
            { l1: "stare → starò", en: "I will stay" },
            { l1: "dovere → dovrò", en: "I will have to" },
            { l1: "potere → potrò", en: "I will be able to" },
            { l1: "volere → vorrò", en: "I will want" },
            { l1: "sapere → saprò", en: "I will know" },
            { l1: "vedere → vedrò", en: "I will see" },
            { l1: "vivere → vivrò", en: "I will live" },
            { l1: "venire → verrò", en: "I will come" },
            { l1: "bere → berrò", en: "I will drink" },
            { l1: "tenere → terrò", en: "I will hold / keep" },
            { l1: "rimanere → rimarrò", en: "I will stay / remain" },
          ],
        },
        {
          type: "tip",
    ...
    },
    {
      ...
      pages: [
        ...
        },
        {
          ...
          items: [
            { l1: "domani", en: "tomorrow" },
            { l1: "dopodomani", en: "the day after tomorrow" },
            { l1: "fra/tra poco", en: "soon / in a little while" },
            { l1: "fra/tra due giorni", en: "in two days" },
            { l1: "la prossima settimana", en: "next week" },
            { l1: "il prossimo mese / anno", en: "next month / year" },
            { l1: "stasera", en: "this evening" },
            { l1: "fra un attimo", en: "in a moment" },
            { l1: "presto", en: "soon" },
            { l1: "in futuro", en: "in the future" },
            { l1: "un giorno", en: "one day" },
          ],
        },
        {
          type: "dialogue",
          ...
          lines: [
            { speaker: "Anna", l1: "Cosa farai questo weekend?", en: "What will you do this weekend?" },
            { speaker: "You", l1: "Sabato andrò al mare con Marco. Domenica resterò a casa a riposare.", en: "Saturday I'll go to the beach with Marco. Sunday I'll stay home and rest." },
            { speaker: "Anna", l1: "E la settimana prossima?", en: "And next week?" },
            { speaker: "You", l1: "Avrò molto lavoro. Comincerò un nuovo progetto lunedì.", en: "I'll have a lot of work. I'll start a new project Monday." },
            { speaker: "Anna", l1: "Sarai stanco. Quando torneremo a vederci?", en: "You'll be tired. When will we see each other again?" },
            { speaker: "You", l1: "Venerdì sera? Ti chiamerò mercoledì per confermare.", en: "Friday evening? I'll call you Wednesday to confirm." },
            { speaker: "Anna", l1: "Perfetto. Sarà bello rivederti!", en: "Perfect. It'll be nice to see you again!" },
          ],
        },
        {
          type: "fillBlank",
