      ...
      pages: [
        ...
        },
        {
          ...
          items: [
            ...
            { l1: "inglese", en: "English (same m/f, ends in -e)" },
            { l1: "francese", en: "French (same m/f)" },
            { l1: "tedesco / tedesca", en: "German" },
            { l1: "spagnolo / spagnola", en: "Spanish" },
            { l1: "canadese", en: "Canadian (same m/f)" },
            { l1: "australiano / australiana", en: "Australian" },
            { l1: "messicano / messicana", en: "Mexican" },
            { l1: "giapponese", en: "Japanese (same m/f)" },
          ],
        },
        {
          type: "tip",
          ...
          example: { l1: "Sono degli Stati Uniti.", en: "I'm from the United States." },
        },
        {
          type: "fillBlank",
    ...
    },
    {
      ...
      pages: [
        ...
        },
        {
          ...
          items: [
            { l1: "insegnante", en: "teacher (m/f)" },
            { l1: "studente / studentessa", en: "student" },
            { l1: "medico", en: "doctor" },
            { l1: "avvocato / avvocata", en: "lawyer" },
            { l1: "ingegnere / ingegnera", en: "engineer" },
            { l1: "infermiere / infermiera", en: "nurse" },
            { l1: "cuoco / cuoca", en: "cook / chef" },
            { l1: "cameriere / cameriera", en: "waiter / waitress" },
            { l1: "operaio / operaia", en: "factory worker" },
            { l1: "impiegato / impiegata", en: "office worker / clerk" },
            { l1: "commesso / commessa", en: "shop assistant" },
            { l1: "pensionato / pensionata", en: "retired person" },
          ],
        },
        {
          type: "vocab",
          heading: "Family",
          items: [
            { l1: "la famiglia", en: "the family" },
            { l1: "il padre / la madre", en: "father / mother" },
            { l1: "papà / mamma", en: "dad / mom (informal)" },
            { l1: "il figlio / la figlia", en: "son / daughter" },
            { l1: "il fratello / la sorella", en: "brother / sister" },
            { l1: "il marito / la moglie", en: "husband / wife" },
            { l1: "il nonno / la nonna", en: "grandfather / grandmother" },
            { l1: "lo zio / la zia", en: "uncle / aunt" },
            { l1: "il cugino / la cugina", en: "cousin" },
            { l1: "il fidanzato / la fidanzata", en: "boyfriend / girlfriend" },
            { l1: "i genitori", en: "the parents (plural)" },
            { l1: "i figli", en: "the children (or just sons)" },
          ],
        },
        {
          type: "dialogue",
          ...
          lines: [
            { speaker: "Marco", l1: "Anna, di dove sei?", en: "Anna, where are you from?" },
            { speaker: "Anna", l1: "Sono di Napoli, ma abito a Roma da cinque anni.", en: "I'm from Naples, but I've lived in Rome for five years." },
            { speaker: "Marco", l1: "Cosa fai?", en: "What do you do?" },
            { speaker: "Anna", l1: "Sono avvocata. E tu?", en: "I'm a lawyer. And you?" },
            { speaker: "Marco", l1: "Faccio l'ingegnere. Sei sposata?", en: "I'm an engineer. Are you married?" },
            { speaker: "Anna", l1: "No, ho un fidanzato. Lui è cuoco.", en: "No, I have a boyfriend. He's a chef." },
            { speaker: "Marco", l1: "Hai fratelli?", en: "Do you have siblings?" },
            { speaker: "Anna", l1: "Sì, ho una sorella più grande e un fratello più piccolo.", en: "Yes, I have an older sister and a younger brother." },
          ],
        },
        {
          type: "multipleChoice",
    ...
    },
    {
      ...
      pages: [
        ...
        },
        {
          ...
          example: { l1: "Marco ha un libro. Il suo libro è interessante.", en: "Marco has a book. His book is interesting." },
        },
        {
          type: "fillBlank",
