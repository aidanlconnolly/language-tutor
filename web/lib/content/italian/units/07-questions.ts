  ...
  lessons: [
    {
      ...
      pages: [
        ...
        },
        {
          ...
          items: [
            { l1: "chi?", en: "who?" },
            { l1: "che? / cosa? / che cosa?", en: "what? (all three are interchangeable)" },
            { l1: "dove?", en: "where?" },
            { l1: "quando?", en: "when?" },
            { l1: "perché?", en: "why? (also = because)" },
            { l1: "come?", en: "how? / how is it? / what's it like?" },
            { l1: "quale? / quali?", en: "which? (sg / pl)" },
            { l1: "quanto? / quanti? / quanta? / quante?", en: "how much / how many (changes with what you're counting)" },
            { l1: "da dove?", en: "from where? (Da dove vieni?)" },
            { l1: "a che ora?", en: "at what time?" },
          ],
        },
        {
          type: "tip",
    ...
    },
    {
      ...
      pages: [
        ...
        },
        {
          ...
          items: [
            { l1: "Parli italiano?", en: "Do you speak Italian?", options: ["You speak Italian.", "Do you speak Italian?", "Speak Italian!", "I speak Italian."], correct: 1 },
            { l1: "Hai fame?", en: "Are you hungry?", options: ["I'm hungry.", "Are you hungry?", "He's hungry.", "We're hungry."], correct: 1 },
            { l1: "Abita a Roma?", en: "Does he/she live in Rome?", options: ["I live in Rome.", "He lives in Rome.", "Does he/she live in Rome?", "Live in Rome!"], correct: 2 },
            { l1: "Siete americani?", en: "Are you (all) American?", options: ["We are American.", "Are you all American?", "They are American.", "I am American."], correct: 1 },
          ],
        },
        {
          type: "dialogue",
          ...
          lines: [
            { speaker: "A", l1: "Sei in vacanza?", en: "Are you on vacation?" },
            { speaker: "B", l1: "Sì, sono qui per una settimana. Tu sei di Roma?", en: "Yes, I'm here for a week. Are you from Rome?" },
            { speaker: "A", l1: "No, sono di Bologna, ma lavoro a Roma. Ti piace la città?", en: "No, I'm from Bologna, but I work in Rome. Do you like the city?" },
            { speaker: "B", l1: "Moltissimo! Hai un consiglio per la cena?", en: "A lot! Do you have a tip for dinner?" },
            { speaker: "A", l1: "Conosci Trastevere? C'è una trattoria fantastica.", en: "Do you know Trastevere? There's a fantastic trattoria." },
          ],
        },
        {
          type: "orderWords",
    ...
    },
    {
      ...
      pages: [
        ...
        },
        {
          ...
          items: [
            { l1: "Come stai? / Come sta?", en: "How are you? (informal / formal)" },
            { l1: "Come va?", en: "How's it going?" },
            { l1: "Quanto costa?", en: "How much does it cost?" },
            { l1: "Quanto fa?", en: "How much is it? (total)" },
            { l1: "Mi scusi, dov'è…?", en: "Excuse me, where is…?" },
            { l1: "Posso…?", en: "May I…?" },
            { l1: "Vorrei…", en: "I'd like… (this isn't a question, but pairs with them)" },
            { l1: "Mi può aiutare?", en: "Can you help me? (formal)" },
            { l1: "Parla inglese?", en: "Do you speak English? (formal)" },
            { l1: "A che ora apre / chiude?", en: "What time does it open / close?" },
            { l1: "Ha la prenotazione?", en: "Do you have a reservation? (formal)" },
            { l1: "Che cosa consiglia?", en: "What do you recommend? (formal)" },
          ],
        },
        {
          type: "tip",
          ...
          example: { l1: "Mi scusi, sa dov'è la metro più vicina?", en: "Excuse me, do you know where the nearest metro is?" },
        },
        {
          type: "fillBlank",
        ...
        },
        {
          ...
          lines: [
            { speaker: "You", l1: "Mi scusi, signora. Dov'è il Pantheon?", en: "Excuse me, ma'am. Where is the Pantheon?" },
            { speaker: "Signora", l1: "È molto vicino! Vede quella strada? Sempre dritto, poi a sinistra.", en: "It's very close! See that street? Straight ahead, then left." },
            { speaker: "You", l1: "Quanto tempo a piedi?", en: "How long on foot?" },
            { speaker: "Signora", l1: "Cinque minuti, non di più.", en: "Five minutes, no more." },
            { speaker: "You", l1: "E un buon bar qui vicino?", en: "And a good café nearby?" },
            { speaker: "Signora", l1: "Sì! Il Caffè Sant'Eustachio è famoso. Costa un po' di più, ma il caffè è il migliore di Roma.", en: "Yes! Caffè Sant'Eustachio is famous. It costs a bit more, but the coffee is the best in Rome." },
            { speaker: "You", l1: "Grazie mille, signora!", en: "Thank you so much, ma'am!" },
          ],
        },
        {
          type: "translate",
