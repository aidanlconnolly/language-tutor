...
export default function AccountPage() {
  ...
  return (
    <main className="mx-auto max-w-3xl px-4 py-8 font-sans sm:px-6 sm:py-10">
      ...
      <section className="mt-12 max-w-sm border-t border-zinc-200 pt-8 dark:border-zinc-800">
        <h2 className="mb-2 text-sm font-semibold uppercase tracking-wider text-red-600 dark:text-red-400">
          Danger zone
        </h2>
        <p className="mb-4 text-sm text-zinc-500 dark:text-zinc-400">
          Permanently delete your account and all progress — lessons, streaks,
          saved words, and review history across every language. This cannot be
          undone.
        </p>
        <form
          ...
          onSubmit={(e) => {
            if (
              !window.confirm(
                "Delete your account and all progress permanently? This cannot be undone.",
              )
            ) {
              e.preventDefault();
            }
        ...
        >
          <button
            type="submit"
            className="w-full rounded-lg border border-red-300 bg-red-50 px-4 py-2 text-sm font-semibold text-red-700 hover:bg-red-100 dark:border-red-900 dark:bg-red-950/40 dark:text-red-300 dark:hover:bg-red-950/70"
          >
            Delete account
          </button>
        </form>
