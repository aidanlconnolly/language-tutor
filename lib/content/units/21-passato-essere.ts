  ...
  lessons: [
    {
      ...
      pages: [
        ...
        },
        {
          ...
          items: [
            { it: "andare → sono andato/a", en: "I went" },
            { it: "venire → sono venuto/a", en: "I came" },
            { it: "arrivare → sono arrivato/a", en: "I arrived" },
            { it: "partire → sono partito/a", en: "I left / departed" },
            { it: "entrare → sono entrato/a", en: "I entered" },
            { it: "uscire → sono uscito/a", en: "I went out" },
            { it: "salire → sono salito/a", en: "I went up / boarded" },
            { it: "scendere → sono sceso/a", en: "I went down / got off" },
            { it: "tornare → sono tornato/a", en: "I returned" },
            { it: "essere → sono stato/a", en: "I was / I have been" },
            { it: "stare → sono stato/a", en: "I stayed (same as essere)" },
            { it: "rimanere → sono rimasto/a", en: "I stayed / remained" },
            { it: "diventare → sono diventato/a", en: "I became" },
            { it: "nascere → sono nato/a", en: "I was born" },
            { it: "morire → è morto/a", en: "he/she died" },
          ],
        },
        {
          type: "tip",
    ...
    },
    {
      ...
      pages: [
        ...
        },
        {
          ...
          lines: [
            { speaker: "Anna", it: "Come è andato il weekend?", en: "How was the weekend?" },
            { speaker: "You", it: "Bellissimo. Sabato sono andato a Firenze in treno. Sono partito presto, alle sette.", en: "Wonderful. Saturday I went to Florence by train. I left early, at seven." },
            { speaker: "Anna", it: "Cosa hai fatto a Firenze?", en: "What did you do in Florence?" },
            { speaker: "You", it: "Ho visitato gli Uffizi, ho camminato in centro, e ho mangiato una bistecca alla fiorentina. Sono rimasto fino alle otto di sera.", en: "I visited the Uffizi, walked in the center, and ate a Florentine steak. I stayed until eight in the evening." },
            { speaker: "Anna", it: "Allora sei tornato la sera?", en: "So you came back in the evening?" },
            { speaker: "You", it: "Sì, sono arrivato a Roma all'una di notte. E tu, cosa hai fatto?", en: "Yes, I got to Rome at one in the morning. And you, what did you do?" },
            { speaker: "Anna", it: "Niente di speciale. Sono rimasta a casa, ho letto un libro, ho cucinato. Tranquillo.", en: "Nothing special. I stayed home, read a book, cooked. Quiet." },
          ],
        },
        {
          type: "fillBlank",
