  ...
  lessons: [
    {
      ...
      pages: [
        ...
        },
        {
          ...
          items: [
            { it: "e / ed", en: "and (use 'ed' before a vowel match)" },
            { it: "ma", en: "but" },
            { it: "o", en: "or" },
            { it: "anche", en: "also / too" },
            { it: "neanche / nemmeno", en: "not even / either (in negatives)" },
            { it: "né… né…", en: "neither… nor…" },
            { it: "o… o…", en: "either… or…" },
            { it: "non solo… ma anche…", en: "not only… but also…" },
          ],
        },
        {
          type: "tip",
          ...
          example: { it: "— Sono stanco. — Anch'io.", en: "— I'm tired. — Me too." },
        },
        {
          type: "fillBlank",
      ...
      pages: [
        ...
        },
        {
          ...
          items: [
            ...
            { it: "perciò", en: "therefore / so (a little formal)" },
            { it: "quindi", en: "so / therefore (very common, neutral)" },
            { it: "allora", en: "so / then / well (multi-purpose discourse word)" },
            { it: "siccome", en: "since / because (starts a clause)" },
            { it: "dato che", en: "given that / since" },
            { it: "così", en: "so / in this way (Sono così stanco. — I'm so tired.)" },
          ],
        },
        {
          type: "tip",
    ...
    },
    {
      ...
      pages: [
        ...
        },
        {
          ...
          items: [
            { it: "prima", en: "before / first" },
            { it: "poi", en: "then / next" },
            { it: "dopo", en: "after / afterward" },
            { it: "infine / alla fine", en: "finally / in the end" },
            { it: "intanto", en: "meanwhile / in the meantime" },
            { it: "però", en: "but / however (stronger than ma)" },
            { it: "invece", en: "instead / on the other hand" },
            { it: "tuttavia", en: "however / yet (more formal)" },
            { it: "comunque", en: "anyway / in any case" },
          ],
        },
        {
          type: "tip",
        ...
        },
        {
          ...
          lines: [
            { speaker: "Anna", it: "Allora, prima mi sveglio alle sette, poi faccio colazione.", en: "So, first I wake up at seven, then I have breakfast." },
            { speaker: "Marco", it: "Cosa mangi?", en: "What do you eat?" },
            { speaker: "Anna", it: "Di solito un cornetto. Però oggi avevo fame, quindi anche un'omelette.", en: "Usually a cornetto. But today I was hungry, so also an omelette." },
            { speaker: "Marco", it: "E dopo?", en: "And after?" },
            { speaker: "Anna", it: "Dopo vado al lavoro in metro. Intanto leggo le notizie sul telefono.", en: "After that I go to work by metro. Meanwhile I read the news on my phone." },
            { speaker: "Marco", it: "Io invece vado a piedi — abito vicino.", en: "I, on the other hand, go on foot — I live nearby." },
            { speaker: "Anna", it: "Beato te! Alla fine arrivo in ufficio alle nove.", en: "Lucky you! In the end I get to the office at nine." },
          ],
        },
        {
          type: "orderWords",
