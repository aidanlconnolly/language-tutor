  ...
  lessons: [
    {
      ...
      pages: [
        ...
        },
        {
          ...
          example: { it: "Mi piace viaggiare in Italia.", en: "I like traveling in Italy." },
        },
        {
          type: "multipleChoice",
    ...
    },
    {
      ...
      pages: [
        ...
        },
        {
          ...
          items: [
            { it: "capire", en: "to understand (capisco, capisci, capisce…)" },
            { it: "finire", en: "to finish (finisco, finisci…)" },
            { it: "pulire", en: "to clean (pulisco…)" },
            { it: "spedire", en: "to send (spedisco…)" },
            { it: "costruire", en: "to build (costruisco…)" },
          ],
        },
        {
          type: "dialogue",
          ...
          lines: [
            { speaker: "Barista", it: "Buongiorno! Mi dica.", en: "Good morning! Tell me." },
            { speaker: "You", it: "Vorrei un cappuccino e un cornetto, per favore.", en: "I'd like a cappuccino and a cornetto, please." },
            { speaker: "Barista", it: "Il cornetto lo preferisce semplice, alla crema o alla marmellata?", en: "Do you prefer the cornetto plain, with cream, or with jam?" },
            { speaker: "You", it: "Preferisco alla crema.", en: "I prefer cream." },
            { speaker: "Barista", it: "Subito! Vuole anche un bicchiere d'acqua?", en: "Right away! Would you also like a glass of water?" },
            { speaker: "You", it: "No, grazie, va bene così.", en: "No thanks, that's fine." },
          ],
        },
        {
          type: "orderWords",
    ...
    },
    {
      ...
      pages: [
        ...
        },
        {
          ...
          example: { it: "Conosco Roma, ma non so come arrivare al Colosseo.", en: "I know Rome, but I don't know how to get to the Colosseum." },
        },
        {
          type: "multipleChoice",
        ...
        },
        {
          ...
          lines: [
            { speaker: "Anna", it: "Conosci Firenze?", en: "Do you know Florence?" },
            { speaker: "Marco", it: "Sì, la conosco bene. Ci sono stato tre volte.", en: "Yes, I know it well. I've been there three times." },
            { speaker: "Anna", it: "Sai dov'è un buon ristorante vicino agli Uffizi?", en: "Do you know where a good restaurant near the Uffizi is?" },
            { speaker: "Marco", it: "So che c'è una trattoria in via dei Neri. Ma non conosco il proprietario.", en: "I know there's a trattoria on via dei Neri. But I don't know the owner." },
            { speaker: "Anna", it: "Perfetto. Andiamo!", en: "Perfect. Let's go!" },
          ],
        },
      ],
    },
