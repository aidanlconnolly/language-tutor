  ...
  lessons: [
    {
      ...
      pages: [
        ...
        },
        {
          ...
          items: [
            { it: "un etto", en: "100 grams" },
            { it: "due etti / mezzo chilo", en: "200g / 500g (same when at ~500)" },
            { it: "un chilo / mezzo chilo / un quarto di chilo", en: "1kg / 500g / 250g" },
            { it: "un litro / mezzo litro", en: "1L / 500ml" },
            { it: "una bottiglia", en: "a bottle" },
            { it: "un sacchetto", en: "a (paper/plastic) bag" },
            { it: "una busta", en: "a bag (plastic)" },
            { it: "una confezione", en: "a package" },
            { it: "una fetta / due fette", en: "a slice / two slices" },
            { it: "un pezzo", en: "a piece" },
            { it: "una manciata", en: "a handful" },
            { it: "qualche", en: "some / a few" },
            { it: "abbastanza", en: "enough" },
          ],
        },
        {
          type: "tip",
    ...
    },
    {
      ...
      pages: [
        ...
        },
        {
          ...
          items: [
            { it: "il mercato", en: "the (outdoor) market" },
            { it: "il supermercato", en: "the supermarket" },
            { it: "il banco / il banchetto", en: "the stall" },
            { it: "il fruttivendolo", en: "the produce seller" },
            { it: "il macellaio", en: "the butcher" },
            { it: "la pescheria / il pescivendolo", en: "the fish shop / fish seller" },
            { it: "la salumeria", en: "the deli (cured meats)" },
            { it: "il fornaio / la panetteria", en: "the baker / bakery" },
            { it: "la frutta", en: "fruit" },
            { it: "la verdura", en: "vegetables" },
            { it: "fresco / fresca", en: "fresh" },
            { it: "maturo", en: "ripe" },
            { it: "biologico / bio", en: "organic" },
            { it: "di stagione", en: "in season" },
            { it: "locale / del posto", en: "local" },
            { it: "il carrello", en: "the shopping cart" },
            { it: "il cestino", en: "the basket" },
          ],
        },
        {
          type: "dialogue",
          ...
          lines: [
            { speaker: "You", it: "Buongiorno. Vorrei mezzo chilo di pomodori, per favore.", en: "Hello. I'd like half a kilo of tomatoes, please." },
            { speaker: "Fruttivendolo", it: "Per oggi o per qualche giorno?", en: "For today or for a few days?" },
            { speaker: "You", it: "Per stasera — faccio una caprese.", en: "For tonight — I'm making a caprese." },
            { speaker: "Fruttivendolo", it: "Allora questi qui sono pronti, perfetti per la caprese. Anche del basilico?", en: "Then these here are ready, perfect for caprese. Some basil too?" },
            { speaker: "You", it: "Sì, un mazzetto. E un etto di mozzarella di bufala, se ne avete.", en: "Yes, a small bunch. And 100g of buffalo mozzarella, if you have it." },
            { speaker: "Fruttivendolo", it: "La bufala la vendiamo al banco del formaggio, qui accanto. Per il resto, tre euro e venti.", en: "We sell the bufala at the cheese stall, right next door. For the rest, three twenty." },
            { speaker: "You", it: "Ecco a Lei. Buona giornata!", en: "Here you go. Have a good day!" },
          ],
        },
        {
          type: "fillBlank",
    ...
    },
    {
      ...
      pages: [
        ...
        },
        {
          ...
          items: [
            { it: "Ne voglio uno.", en: "I want one (of them)." },
            { it: "Ne prendo due.", en: "I'll take two." },
            { it: "Ne ho.", en: "I have some." },
            { it: "Non ne ho.", en: "I don't have any." },
            { it: "Ne abbiamo bisogno.", en: "We need some / it." },
            { it: "Quanti ne vuole?", en: "How many do you want?" },
            { it: "Non ne so niente.", en: "I don't know anything about it." },
            { it: "Cosa ne pensi?", en: "What do you think (of it)?" },
          ],
        },
        {
          type: "tip",
        ...
        },
        {
          ...
          lines: [
            { speaker: "Salumiere", it: "Mi dica.", en: "Tell me." },
            { speaker: "You", it: "Vorrei del pecorino romano. Quanto costa?", en: "I'd like some pecorino romano. How much is it?" },
            { speaker: "Salumiere", it: "Due e ottanta all'etto. Quanto ne vuole?", en: "Two eighty per 100g. How much (of it) do you want?" },
            { speaker: "You", it: "Ne prendo tre etti. E delle olive nere?", en: "I'll take 300g (of it). And some black olives?" },
            { speaker: "Salumiere", it: "Quante ne vuole?", en: "How many (of them) do you want?" },
            { speaker: "You", it: "Ne voglio circa un etto.", en: "I want about 100g (of them)." },
            { speaker: "Salumiere", it: "Ecco. Altro?", en: "Here. Anything else?" },
            { speaker: "You", it: "No, basta così, grazie.", en: "No, that's enough, thanks." },
          ],
        },
        {
          type: "orderWords",
