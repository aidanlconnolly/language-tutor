  ...
  lessons: [
    {
      ...
      pages: [
        ...
        },
        {
          ...
          items: [
            { l1: "(tu) Come stai? / (Lei) Come sta?", en: "How are you?" },
            { l1: "(tu) Cosa fai? / (Lei) Cosa fa?", en: "What are you doing?" },
            { l1: "(tu) Di dove sei? / (Lei) Di dov'è?", en: "Where are you from?" },
            { l1: "(tu) Mi puoi aiutare? / (Lei) Mi può aiutare?", en: "Can you help me?" },
            { l1: "(tu) Hai un attimo? / (Lei) Ha un attimo?", en: "Do you have a moment?" },
            { l1: "(tu) Scusa! / (Lei) Mi scusi!", en: "Excuse me!" },
            { l1: "(tu) Senti / (Lei) Senta", en: "Hey / Listen (getting attention)" },
            { l1: "(tu) Dimmi / (Lei) Mi dica", en: "Tell me" },
            { l1: "(tu) Vieni qui / (Lei) Venga qui", en: "Come here" },
            { l1: "(tu) Parli inglese? / (Lei) Parla inglese?", en: "Do you speak English?" },
          ],
        },
        {
          type: "tip",
    ...
    },
    {
      ...
      pages: [
        ...
        },
        {
          ...
          example: { l1: "Informal: scusami! / Formal: mi scusi!", en: "Excuse me!" },
        },
        {
          type: "fillBlank",
    ...
    },
    {
      ...
      pages: [
        ...
        },
        {
          ...
          items: [
            { l1: "signore / signora", en: "sir / ma'am (use these — Italians love them)" },
            { l1: "mi scusi", en: "excuse me (formal)" },
            { l1: "mi può…?", en: "can you…? (formal)" },
            { l1: "Le dispiace…?", en: "do you mind…? (very polite)" },
            { l1: "Le posso chiedere…?", en: "may I ask you…?" },
            { l1: "se non Le dispiace", en: "if you don't mind" },
            { l1: "la ringrazio", en: "I thank you (formal, strong)" },
            { l1: "molto gentile", en: "very kind" },
            { l1: "è stato un piacere", en: "it has been a pleasure" },
            { l1: "arrivederLa / arrivederci", en: "goodbye (formal / neutral)" },
            { l1: "buona giornata / serata", en: "have a good day / evening" },
          ],
        },
        {
          type: "dialogue",
          ...
          lines: [
            { speaker: "You", l1: "Buongiorno, signora. Mi scusi se La disturbo.", en: "Good morning, ma'am. Sorry to bother you." },
            { speaker: "Farmacista", l1: "Mi dica, in cosa La posso aiutare?", en: "Tell me, how can I help you?" },
            { speaker: "You", l1: "Avrei bisogno di qualcosa per il mal di gola. Cosa mi consiglia?", en: "I'd need something for a sore throat. What do you recommend?" },
            { speaker: "Farmacista", l1: "Le do questi sciroppi naturali. Ne prenda un cucchiaino tre volte al giorno.", en: "I'll give you these natural syrups. Take a teaspoonful three times a day." },
            { speaker: "You", l1: "Perfetto. Quanto Le devo?", en: "Perfect. How much do I owe you?" },
            { speaker: "Farmacista", l1: "Otto e cinquanta. Vuole anche un'aspirina?", en: "Eight fifty. Would you also like an aspirin?" },
            { speaker: "You", l1: "No, grazie. La ringrazio davvero, è stata molto gentile.", en: "No, thanks. I really thank you, you've been very kind." },
            { speaker: "Farmacista", l1: "Si figuri. Guarisca presto. Buona giornata.", en: "Don't mention it. Get well soon. Have a good day." },
            { speaker: "You", l1: "Anche a Lei, arrivederLa.", en: "You too, goodbye." },
          ],
        },
        {
          type: "fillBlank",
