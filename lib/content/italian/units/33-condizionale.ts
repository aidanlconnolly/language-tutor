    ...
    },
    {
      ...
      pages: [
        ...
        },
        {
          ...
          items: [
            { l1: "Vorrei…", en: "I'd like… (the polite default)" },
            { l1: "Potresti / Potrebbe…?", en: "Could you…? (informal / formal)" },
            { l1: "Dovresti…", en: "You should… (gentle advice)" },
            { l1: "Mi piacerebbe…", en: "I would like (to) …" },
            { l1: "Sarebbe meglio…", en: "It would be better…" },
            { l1: "Sarebbe possibile…?", en: "Would it be possible…?" },
            { l1: "Mi darebbe / Mi daresti…?", en: "Would you give me…? (formal / informal)" },
            { l1: "Cosa faresti?", en: "What would you do?" },
            { l1: "Andrei volentieri", en: "I'd gladly go" },
            { l1: "Avrei una domanda", en: "I would have a question (very polite way to start)" },
          ],
        },
        {
          type: "dialogue",
          ...
          lines: [
            { speaker: "You", l1: "Buonasera. Avrei una richiesta — sarebbe possibile cambiare camera?", en: "Good evening. I'd have a request — would it be possible to change rooms?" },
            { speaker: "Receptionist", l1: "Certo, mi dica. C'è un problema?", en: "Of course, tell me. Is there a problem?" },
            { speaker: "You", l1: "La camera attuale è un po' rumorosa. Vorrei qualcosa di più tranquillo, se è disponibile.", en: "The current room is a bit noisy. I'd like something quieter, if available." },
            { speaker: "Receptionist", l1: "Capisco. Le potrei dare la 405 al quarto piano. Sarebbe più silenziosa.", en: "I understand. I could give you 405 on the fourth floor. It would be quieter." },
            { speaker: "You", l1: "Sarebbe perfetto. Quando potrei spostarmi?", en: "That would be perfect. When could I move?" },
            { speaker: "Receptionist", l1: "Tra mezz'ora, dopo le pulizie. Vorrebbe che le portiamo le valigie?", en: "In half an hour, after cleaning. Would you like us to bring your suitcases?" },
            { speaker: "You", l1: "No, grazie, faccio io. Grazie davvero!", en: "No thanks, I'll do it. Thank you really!" },
          ],
        },
        {
          type: "fillBlank",
    ...
    },
    {
      ...
      pages: [
        ...
        },
        {
          ...
          items: [
            { l1: "Se fossi in te / al posto tuo", en: "If I were you / in your place" },
            { l1: "Dovresti…", en: "You should…" },
            { l1: "Potresti…", en: "You could…" },
            { l1: "Ti consiglierei…", en: "I'd recommend you…" },
            { l1: "Sarebbe meglio…", en: "It would be better…" },
            { l1: "Sarebbe il caso di…", en: "It would be appropriate to…" },
            { l1: "Penso che dovresti…", en: "I think you should…" },
            { l1: "Forse potresti…", en: "Maybe you could…" },
            { l1: "Magari…", en: "Maybe / hopefully…" },
            { l1: "Non sarebbe meglio…?", en: "Wouldn't it be better…?" },
          ],
        },
        {
          type: "dialogue",
          ...
          lines: [
            { speaker: "Anna", l1: "Sono stressatissima. Non so cosa fare con il mio capo.", en: "I'm super stressed. I don't know what to do with my boss." },
            { speaker: "You", l1: "Mi dispiace. Se fossi in te, gli parlerei direttamente.", en: "I'm sorry. If I were you, I'd talk to him directly." },
            { speaker: "Anna", l1: "Pensi? Ho paura che si arrabbi.", en: "You think? I'm afraid he'll get angry." },
            { speaker: "You", l1: "Forse potresti scrivergli una mail prima, per spiegare la situazione con calma.", en: "Maybe you could write him an email first, to explain the situation calmly." },
            { speaker: "Anna", l1: "Sarebbe più semplice, sì.", en: "It would be easier, yes." },
            { speaker: "You", l1: "Esatto. Sarebbe meglio risolvere la cosa prima che diventi più grande.", en: "Exactly. It would be better to solve it before it gets bigger." },
            { speaker: "Anna", l1: "Hai ragione. Grazie, mi hai aiutato molto.", en: "You're right. Thanks, you've helped a lot." },
          ],
        },
        {
          type: "fillBlank",
