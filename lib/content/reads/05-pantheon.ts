...
export const READ_PANTHEON: DailyRead = {
  ...
  stageUnlock: 1,
  difficulty: 6,
  titleIt: "Un pomeriggio al Pantheon",
  ...
  paragraphs: [
    {
      it: "È un pomeriggio caldo di giugno. Decido di visitare il Pantheon, uno dei monumenti più antichi di Roma. Ho una bottiglia d'acqua nella borsa e un cappello sulla testa, perché il sole è forte.",
    ...
    {
      it: "Cammino per le strade del centro storico. Le strade sono strette, piene di turisti, ma molto belle. Vedo piccoli negozi che vendono libri vecchi, gelaterie con dieci gusti diversi, e bar con tavolini all'aperto.",
    ...
    {
      it: "Arrivo in Piazza della Rotonda. Il Pantheon è enorme. Le colonne sono altissime e grigie. C'è una fila di persone davanti all'ingresso. Aspetto venti minuti, ma vale la pena.",
    ...
    {
      it: "Quando entro, alzo gli occhi. Il soffitto è incredibile: c'è un grande buco rotondo nel mezzo, che si chiama l'«oculus». La luce del sole entra dall'oculus e disegna un cerchio dorato sul pavimento.",
    ...
    {
      it: "Una guida turistica spiega ai visitatori la storia: «Il Pantheon è del secondo secolo. Ha quasi duemila anni. Quando piove, l'acqua entra dall'oculus, ma il pavimento ha piccoli buchi per far uscire l'acqua.» Mi piacciono molto questi dettagli pratici.",
    ...
    {
      it: "Resto dentro venti minuti. Faccio alcune foto, ma i telefoni non possono catturare la sensazione di essere lì. È più impressionante di tutti i monumenti che ho visto prima.",
    ...
    {
      it: "Esco dal Pantheon e cerco un gelato. Trovo una gelateria piccola accanto alla piazza. Prendo un cono con due gusti: pistacchio e stracciatella. Mi siedo su una panchina e guardo le persone che entrano ed escono dal Pantheon. Penso che Roma è una città magica.",
  ...
  vocabSpotlight: [
    { it: "il monumento", en: "the monument" },
    { it: "il centro storico", en: "the historic center" },
    { it: "la colonna", en: "the column" },
    { it: "la fila", en: "the line / queue" },
    { it: "il soffitto", en: "the ceiling" },
    { it: "il pavimento", en: "the floor" },
    { it: "valere la pena", en: "to be worth it" },
    { it: "la gelateria", en: "the gelato shop" },
    { it: "il gusto", en: "the flavor" },
  ],
  comprehension: [
    {
