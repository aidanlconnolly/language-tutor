...
export const READ_MONTI_HOTEL: DailyRead = {
  ...
  paragraphs: [
    {
      it: "Sono in un taxi. Il taxi va verso il mio hotel. L'hotel è nel quartiere di Monti.",
      en: "I'm in a taxi. The taxi is going to my hotel. The hotel is in the Monti neighborhood.",
    },
    {
      it: "Il taxi si ferma davanti a una porta gialla. Il numero è 24. Vedo un'insegna piccola: «Hotel Stella di Monti».",
      en: "The taxi stops in front of a yellow door. The number is 24. I see a small sign: \"Hotel Stella di Monti.\"",
    },
    {
      it: "Entro nell'hotel. C'è una donna alla reception. Si chiama Giulia. Lei sorride e dice: «Buongiorno! Mi dica.»",
      en: "I enter the hotel. There's a woman at the reception. Her name is Giulia. She smiles and says: \"Good morning! Tell me.\"",
    },
    {
      it: "«Buongiorno. Ho una prenotazione. Mi chiamo Marco.» Lei guarda il computer. «Sì, Marco! Cinque notti, camera 3B. Va bene?»",
    ...
    {
      it: "«Sì, perfetto. Vorrei una camera tranquilla, per favore.» «La 3B è tranquilla. È in fondo al corridoio. C'è un balcone piccolo.»",
      en: "\"Yes, perfect. I'd like a quiet room, please.\" \"3B is quiet. It's at the end of the hallway. There's a small balcony.\"",
    },
    {
      it: "Giulia mi dà la chiave. «Ecco la chiave. La colazione è dalle sette alle dieci. C'è il caffè, il pane, la marmellata.»",
      en: "Giulia gives me the key. \"Here's the key. Breakfast is from seven to ten. There's coffee, bread, and jam.\"",
    },
    {
      it: "«Grazie mille, Giulia. A che ora chiude la reception?» «Non chiude mai. C'è sempre qualcuno qui.»",
      en: "\"Thank you so much, Giulia. What time does the reception close?\" \"It never closes. There's always someone here.\"",
    },
    {
      it: "Salgo le scale. Trovo la camera 3B. Apro la porta. La camera è piccola ma bella. Vedo un letto, una sedia, una finestra. Sono a Roma. Sono stanco, ma sono felice.",
  ...
  vocabSpotlight: [
    ...
    { it: "la camera", en: "the (hotel) room" },
    { it: "la chiave", en: "the key" },
    { it: "il corridoio", en: "the hallway" },
    { it: "tranquillo", en: "quiet / calm" },
    { it: "la colazione", en: "breakfast" },
    { it: "vorrei", en: "I would like (polite)" },
