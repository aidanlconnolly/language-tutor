...
export const READ_MERCATO: DailyRead = {
  ...
  stageUnlock: 1,
  difficulty: 6.5,
  titleIt: "Al mercato di Campo de' Fiori",
  ...
  paragraphs: [
    {
      it: "È martedì mattina. Mi piace fare la spesa al mercato di Campo de' Fiori. Il mercato apre presto, alle sette, e chiude verso le due del pomeriggio. Arrivo alle nove con una borsa di tela vuota.",
    ...
    {
      it: "La piazza è piena di colori. I banchi vendono di tutto: pomodori rossi e maturi, zucchine verdi lunghe, peperoni gialli e arancioni, basilico fresco, fragole rosse, limoni grandi della Sicilia.",
    ...
    {
      it: "Mi avvicino al banco di un signore anziano con un grembiule blu. Lui mi guarda e dice: «Buongiorno, giovane! Cosa Le serve oggi?» Rispondo: «Vorrei mezzo chilo di pomodori e un mazzetto di basilico, per favore.»",
    ...
    {
      it: "Lui prende i pomodori con cura, uno per uno. «Questi sono i migliori. Vengono dalla mia campagna, vicino a Frascati.» Mi mostra anche le zucchine. «E queste? Sono freschissime, le ho raccolte ieri mattina.»",
    ...
    {
      it: "«Allora prendo anche tre zucchine. Quanto fa in tutto?» Lui pesa la verdura sulla bilancia. «Pomodori, basilico, zucchine… sette euro e cinquanta.» Pago con dieci euro e lui mi dà il resto. «Grazie, signore. A presto!»",
    ...
    {
      it: "Continuo a girare per il mercato. Compro anche un po' di formaggio, del prosciutto, e un pezzo di pane fresco. Una signora del banco del formaggio mi fa assaggiare un pecorino stagionato. È molto saporito.",
    ...
    {
      it: "Alla fine la mia borsa è piena e pesante. Stasera cucino una pasta con i pomodori freschi e il basilico. Penso: in Italia, il cibo non è solo cibo. È un modo per parlare con la gente, per conoscere la città, per sentirsi a casa.",
  ...
  vocabSpotlight: [
    ...
    { it: "fare la spesa", en: "to do the grocery shopping" },
    { it: "il banco", en: "the stall (at a market)" },
    { it: "maturo", en: "ripe" },
    { it: "mezzo chilo", en: "half a kilo" },
    { it: "un mazzetto", en: "a small bunch (of herbs)" },
    { it: "la bilancia", en: "the scale" },
    { it: "il resto", en: "the change (money back)" },
    { it: "assaggiare", en: "to taste / sample" },
    { it: "stagionato", en: "aged (cheese, ham)" },
  ],
  comprehension: [
    {
